...
export const ErrorToast = ({
  ...
  return (
    <div
      className={`${staticPosition ? "relative" : "fixed top-10 right-10"} z-[100] flex transform items-center gap-3 rounded-xl border ${config.borderColor} ${config.bgColor} p-4 shadow-2xl transition-all duration-300 ${
        show
